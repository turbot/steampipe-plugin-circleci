...
func tableCircleciBuild() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "failed", Description: "Indicates if the build was failed.", Type: proto.ColumnType_BOOL},
			{Name: "infrastructure_fail", Description: "Indicates if the build was failed due to infrastructure.", Type: proto.ColumnType_BOOL},
			...
			{Name: "queued_at", Description: "Timestamp of when the build was queued.", Type: proto.ColumnType_STRING},
			{Name: "reponame", Description: "Repository bane.", Type: proto.ColumnType_STRING},
			...
			{Name: "timedout", Description: "Indicates if the build got timedout.", Type: proto.ColumnType_BOOL},
			{Name: "usage_queued_at", Description: "Usage queued time.", Type: proto.ColumnType_STRING},
